    """
    Pdf Export Service 3ebl9um
    ==========================
    Minimal HTTP service that acts as a cache layer for existing third-party APIs.
    ...
    APP_NAME    = "Pdf Export Service 3ebl9um"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Minimal HTTP service that acts as a cache layer for existing third-party APIs.")
